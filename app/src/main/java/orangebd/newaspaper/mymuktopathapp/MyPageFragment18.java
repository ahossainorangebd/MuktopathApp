...
public class MyPageFragment18 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_my_page_fragment18, container, false);
        ...
        DetailDataModelCoursesThumbnails imgUrlModel = imgArray.get(17);
        ...
        final ArrayList<ArrayList<DetailDataModelCoursesDetailContents>> pulseMultiArray = GlobalVar.courseContentDetailList.get(0).getmArrayListCourseVideoPulseMulti().get(17);
        final ArrayList<DetailDataModelCoursesDetailContents> contents = contentArray.get(17);
        ...
        final ArrayList<DetailDataModelCoursesDetailContents> quizes = quizArray.get(17);
        ...
        int mAssignmentNumbers=GlobalVar.gEnrollCourseList.get(17).getmAssignmentNumbers();
        int mExamNumbers=GlobalVar.gEnrollCourseList.get(17).getmExamNumbers();
        ...
        if(mAssignmentNumbers>0){
            ...
            int contentListCount3=GlobalVar.courseContentDetailList.get(0).getmUnitDataArrayListContent3().get(17).size();

            int contentDuration3=0;

            for (int timeCount3=0; timeCount3<contentListCount3 ; timeCount3++) {

                String temptestList3=GlobalVar.courseContentDetailList.get(0).getmUnitDataArrayListContent3().get(17).get(timeCount3).getmDurationAnother();
        ...
        if(mExamNumbers>0){
            ...
            int contentListCount2=GlobalVar.courseContentDetailList.get(0).getmUnitDataArrayListContent2().get(17).size();
            int contentDuration2=0;

            for (int timeCount2=0; timeCount2<contentListCount2 ; timeCount2++) {

                String temptestList2=GlobalVar.courseContentDetailList.get(0).getmUnitDataArrayListContent2().get(17).get(timeCount2).getmDurationAnother();
        ...
        if(mContentNumbers>0){
            ...
            int contentListCount=GlobalVar.courseContentDetailList.get(0).getmUnitDataArrayListContent().get(17).size();
            int contentDuration=0;

            for (int timeCount=0; timeCount<contentListCount ; timeCount++) {

                String temptestList=GlobalVar.courseContentDetailList.get(0).getmUnitDataArrayListContent().get(17).get(timeCount).getmDurationAnother();
