...
public class MyPageDetailFragment9 extends Fragment {
    ...
    private int thisFragmentUniNumber=8;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view= inflater.inflate(R.layout.fragment_my_page_detail_fragment9, container, false);

        context=getContext();


        //handling the global dynamic unit numbers
        if(GlobalVar.gEnrolledCourseUnitSize==9){
