...
public class TabsPagerAdapterPulseQuiz extends FragmentPagerAdapter {
    ...
    public TabsPagerAdapterPulseQuiz(FragmentManager fm) {
        super(fm);
    }
    ...
    public int getCount() {
        ...
        return GlobalVar.gTotalQuizNumberThisCourse=1;
        //return NUM_ITEMS;
    }
    ...
    public Fragment getItem(int position) {
        ...
        if(GlobalVar.gTotalQuizNumberThisCourse==1){
            switch (position) {
        ...
        else if(GlobalVar.gTotalQuizNumberThisCourse==2){
            switch (position) {
