...
public class MyPageDetailFragment7 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view= inflater.inflate(R.layout.fragment_my_page_detail_fragment7, container, false);


        context=getContext();

        //handling the global dynamic unit numbers
        if(GlobalVar.gEnrolledCourseUnitSize==7){
