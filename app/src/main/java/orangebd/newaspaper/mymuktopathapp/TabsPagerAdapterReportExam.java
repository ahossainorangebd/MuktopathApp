...
public class TabsPagerAdapterReportExam extends FragmentPagerAdapter {
    ...
    public TabsPagerAdapterReportExam(FragmentManager fm) {
        super(fm);
    }
    ...
    public Fragment getItem(int position) {
        ...
        if(GlobalVar.gTotalExamNumberThisCourse==2){
            switch (position) {
                ...
                case 0:
                    return new ExamReportCongratzFragment();
                case 1:
                    return new ExamReportFragment1();
                default:
                    return null;
            }
        }
            ...
            switch (position) {
                ...
                case 1:
                    return new ExamReportFragment1();
                case 2:
                    return new ExamReportFragment2();
                default:
                    return null;
            }
        }
        ...
        else if(GlobalVar.gTotalExamNumberThisCourse==4)
        {
            switch (position) {
                ...
                case 2:
                    return new ExamReportFragment2();
                case 3:
                    return new ExamReportFragment3();
                default:
                    return null;
            }
        }
        ...
        else if(GlobalVar.gTotalExamNumberThisCourse==5)
        {
            switch (position) {
                ...
                case 3:
                    return new ExamReportFragment3();
                case 4:
                    return new ExamReportFragment4();
                default:
                    return null;
            }
        }
        ...
        else if(GlobalVar.gTotalExamNumberThisCourse==6)
        {
            switch (position) {
                ...
                case 4:
                    return new ExamReportFragment4();
                case 5:
                    return new ExamReportFragment5();
                default:
                    return null;
            }
        }
        ...
        else if(GlobalVar.gTotalExamNumberThisCourse==7)
        {
            switch (position) {
                ...
                case 5:
                    return new ExamReportFragment5();
                case 6:
                    return new ExamReportFragment6();
                default:
                    return null;
            }
        }
        ...
        else if(GlobalVar.gTotalExamNumberThisCourse==8)
        {
            switch (position) {
                ...
                case 6:
                    return new ExamReportFragment6();
                case 7:
                    return new ExamReportFragment7();
                default:
                    return null;
            }
        }
        ...
        else if(GlobalVar.gTotalExamNumberThisCourse==9)
        {
            switch (position) {
                ...
                case 7:
                    return new ExamReportFragment7();
                case 8:
                    return new ExamReportFragment8();
                default:
                    return null;
            }
        }
        ...
        else if(GlobalVar.gTotalExamNumberThisCourse==10)
        {
            switch (position) {
                ...
                case 8:
                    return new ExamReportFragment8();
                case 9:
                    return new ExamReportFragment9();
                default:
                    return null;
            }
        }
        ...
        else if(GlobalVar.gTotalExamNumberThisCourse==11)
        {
            switch (position) {
                ...
                case 9:
                    return new ExamReportFragment9();
                case 10:
                    return new ExamReportFragment10();
                default:
                    return null;
            }
        }
