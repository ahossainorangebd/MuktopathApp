...
public class ExamFragment12 extends Fragment {

    private int prevExam=10;
    private int nthExam=11;
    private int nextExam=12;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_exam_fragment12, container, false);
