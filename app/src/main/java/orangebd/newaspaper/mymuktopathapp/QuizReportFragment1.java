...
public class QuizReportFragment1 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view=inflater.inflate(R.layout.fragment_quiz_report_fragment1, container, false);
        ...
        if(quizSumDesc.equalsIgnoreCase("&nbsp;")){
            quizSumDesc="";
        }

        if(quizSumDesc.equalsIgnoreCase(null)){
            quizSumDesc="";
        }
