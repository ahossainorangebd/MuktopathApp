...
public class ExamFragment5 extends Fragment {

    private int nextExam=5;
    private int prevExam=3;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_exam_fragment5, container, false);
