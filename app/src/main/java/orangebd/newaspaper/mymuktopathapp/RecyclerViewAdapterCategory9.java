...
public class RecyclerViewAdapterCategory9 extends RecyclerView.Adapter<RecyclerViewAdapterCategory9.MyViewHolder> {
    ...
    public RecyclerViewAdapterCategory9(ArrayList<DetailDataModelCourses> data, Context context) {
        this.dataSet = data;
