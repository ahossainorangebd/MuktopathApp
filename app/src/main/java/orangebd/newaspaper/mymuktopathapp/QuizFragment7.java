...
public class QuizFragment7 extends Fragment {
    ...
    private int prevExam=5;
    private int nextExam=7;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_quiz_fragment7, container, false);
