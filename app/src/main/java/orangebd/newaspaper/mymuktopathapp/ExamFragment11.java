...
public class ExamFragment11 extends Fragment {

    private int prevExam=9;
    private int nextExam=11;

    private int nthExam=10;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_exam_fragment11, container, false);
