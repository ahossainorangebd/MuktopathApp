...
public class MyPageFragment15 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        DetailDataModelCoursesThumbnails imgUrlModel = imgArray.get(14);
        ...
        final ArrayList<ArrayList<DetailDataModelCoursesDetailContents>> pulseMultiArray = GlobalVar.courseContentDetailList.get(0).getmArrayListCourseVideoPulseMulti().get(14);
        final ArrayList<ArrayList<DetailDataModelCoursesDetailContents>> contents = contentArray.get(14);
        ...
        if(GlobalVar.gEnrollCourseNumber==15){
        ...
        if(mAssignmentNumbers>0){
            ...
            int contentListCount3=GlobalVar.courseContentDetailList.get(0).getmUnitDataArrayListContent3().get(14).size();

            int contentDuration3=0;

            for (int timeCount3=0; timeCount3<contentListCount3 ; timeCount3++) {

                String temptestList3=GlobalVar.courseContentDetailList.get(0).getmUnitDataArrayListContent3().get(14).get(timeCount3).getmDurationAnother();
        ...
        if(mExamNumbers>0){
            ...
            int contentListCount2=GlobalVar.courseContentDetailList.get(0).getmUnitDataArrayListContent2().get(14).size();
            int contentDuration2=0;

            for (int timeCount2=0; timeCount2<contentListCount2 ; timeCount2++) {

                String temptestList2=GlobalVar.courseContentDetailList.get(0).getmUnitDataArrayListContent2().get(14).get(timeCount2).getmDurationAnother();
        ...
        if(mContentNumbers>0){
            ...
            int contentListCount=GlobalVar.courseContentDetailList.get(0).getmUnitDataArrayListContent().get(14).size();
            int contentDuration=0;

            for (int timeCount=0; timeCount<contentListCount ; timeCount++) {

                String temptestList=GlobalVar.courseContentDetailList.get(0).getmUnitDataArrayListContent().get(14).get(timeCount).getmDurationAnother();
