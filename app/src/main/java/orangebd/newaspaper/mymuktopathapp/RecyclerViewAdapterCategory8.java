...
public class RecyclerViewAdapterCategory8 extends RecyclerView.Adapter<RecyclerViewAdapterCategory8.MyViewHolder> {
    ...
    public RecyclerViewAdapterCategory8(ArrayList<DetailDataModel> data, Context context) {
        this.dataSet = data;
