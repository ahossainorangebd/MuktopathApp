...
public class QuizFragment6 extends Fragment {
    ...
    private int prevExam=4;
    private int nextExam=6;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_quiz_fragment6, container, false);
