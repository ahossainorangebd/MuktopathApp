...
public class MyPageFragment10 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if(mAssignmentNumbers==0){
            ...
            int contentListCount3=GlobalVar.courseContentDetailList.get(9).getmUnitDataArrayListContent().get(2).size();

            int contentDuration3=0;

            for (int timeCount3=0; timeCount3<contentListCount3-1 ; timeCount3++) {

                String temptestList3=GlobalVar.courseContentDetailList.get(9).getmUnitDataArrayListContent().get(2).get(timeCount3).getmDurationAnother();
        ...
        if(mExamNumbers==0){
            ...
            int contentListCount2=GlobalVar.courseContentDetailList.get(9).getmUnitDataArrayListContent().get(1).size();
            int contentDuration2=0;

            for (int timeCount2=0; timeCount2<contentListCount2-1 ; timeCount2++) {

                String temptestList2=GlobalVar.courseContentDetailList.get(9).getmUnitDataArrayListContent().get(1).get(timeCount2).getmDurationAnother();
        ...
        if(mContentNumbers==0){
            ...
            int contentListCount=GlobalVar.courseContentDetailList.get(9).getmUnitDataArrayListContent().get(0).size();
            int contentDuration=0;

            for (int timeCount=0; timeCount<contentListCount-1 ; timeCount++) {

                String temptestList=GlobalVar.courseContentDetailList.get(9).getmUnitDataArrayListContent().get(0).get(timeCount).getmDurationAnother();
