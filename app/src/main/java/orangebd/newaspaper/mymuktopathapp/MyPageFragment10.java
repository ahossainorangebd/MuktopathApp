...
public class MyPageFragment10 extends Fragment {
                             ...
                             Bundle savedInstanceState)
    {
        ...
        final String CoverPhoto = GlobalVar.gBaseUrl + "/cache-images/" + "21nthCoursex145x1" + "/uploads/images/" + imgUrl;
        ...
        if(GlobalVar.gEnrollCourseNumber==10){
