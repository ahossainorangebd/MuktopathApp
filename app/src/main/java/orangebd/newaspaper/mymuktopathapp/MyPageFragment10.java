...
public class MyPageFragment10 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        int mAssignmentNumbers=GlobalVar.gEnrolledInstitution.get(9).getmAssignmentNumbers();
        int mExamNumbers=GlobalVar.gEnrolledInstitution.get(9).getmExamNumbers();
