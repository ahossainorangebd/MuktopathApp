...
public class RecyclerViewAdapterCategory4 extends RecyclerView.Adapter<RecyclerViewAdapterCategory4.MyViewHolder> {
    ...
    public RecyclerViewAdapterCategory4(ArrayList<DetailDataModelCourses> data, Context context) {
        this.dataSet = data;
