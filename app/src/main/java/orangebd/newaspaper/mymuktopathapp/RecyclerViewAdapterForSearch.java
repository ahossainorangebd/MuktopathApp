...
public class RecyclerViewAdapterForSearch extends RecyclerView.Adapter<RecyclerViewAdapterForSearch.MyViewHolder> {
    ...
    public RecyclerViewAdapterForSearch(ArrayList<DetailDataModelCourses> data, Context context) {
        this.dataSet = data;
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        try {
            view = LayoutInflater.from(parent.getContext()).inflate(R.layout.cards_layout_search, parent, false);
        }
        catch (Exception ex){
            Log.d("", ex.getMessage());
        }
