...
public class MyPageFragment4 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        String enrolledCourseTitle=GlobalVar.gEnrollCourseList.get(3).getmCourseAliasName();
        String enrolledCourseOwner=GlobalVar.gEnrolledInstitution.get(3).getInstitution_name_owner();
