...
public class RecyclerViewAdapterCategory2 extends RecyclerView.Adapter<RecyclerViewAdapterCategory2.MyViewHolder> {
    ...
    public RecyclerViewAdapterCategory2(ArrayList<DetailDataModel> data, Context context) {
        this.dataSet = data;
