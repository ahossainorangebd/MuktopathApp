...
public class ExamFragment4 extends Fragment {

    private int nextExam=4;
    private int prevExam=2;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_exam_fragment4, container, false);
