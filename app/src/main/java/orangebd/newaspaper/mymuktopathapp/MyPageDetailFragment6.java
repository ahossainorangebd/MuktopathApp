...
public class MyPageDetailFragment6 extends Fragment {
    ...
    private int thisFragmentUniNumber=5;

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {

        view= inflater.inflate(R.layout.fragment_my_page_detail_fragment6, container, false);
